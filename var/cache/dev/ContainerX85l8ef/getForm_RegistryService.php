...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AtributType' => ['privates', 'App\\Form\\AtributType', 'getAtributTypeService', true],
            ...
            'App\\Form\\DobavljacType' => ['privates', 'App\\Form\\DobavljacType', 'getDobavljacTypeService', true],
            'App\\Form\\FirmaType' => ['privates', 'App\\Form\\FirmaType', 'getFirmaTypeService', true],
            'App\\Form\\GazdinstvoType' => ['privates', 'App\\Form\\GazdinstvoType', 'getGazdinstvoTypeService', true],
            'App\\Form\\KomentarProizvodaType' => ['privates', 'App\\Form\\KomentarProizvodaType', 'getKomentarProizvodaTypeService', true],
            'App\\Form\\KontaktType' => ['privates', 'App\\Form\\KontaktType', 'getKontaktTypeService', true],
            'App\\Form\\OrderType' => ['privates', 'App\\Form\\OrderType', 'getOrderTypeService', true],
            'App\\Form\\ProfilPassType' => ['privates', 'App\\Form\\ProfilPassType', 'getProfilPassTypeService', true],
            'App\\Form\\ProfilType' => ['privates', 'App\\Form\\ProfilType', 'getProfilTypeService', true],
            'App\\Form\\ProizvodType' => ['privates', 'App\\Form\\ProizvodType', 'getProizvodTypeService', true],
            'App\\Form\\RegistrationFizickoType' => ['privates', 'App\\Form\\RegistrationFizickoType', 'getRegistrationFizickoTypeService', true],
            'App\\Form\\RegistrationGazdinstvoType' => ['privates', 'App\\Form\\RegistrationGazdinstvoType', 'getRegistrationGazdinstvoTypeService', true],
            ...
            'App\\Form\\RezervacijaType' => ['privates', 'App\\Form\\RezervacijaType', 'getRezervacijaTypeService', true],
            ...
            'App\\Form\\AtributType' => '?',
            'App\\Form\\CategoryType' => '?',
            'App\\Form\\ChangePasswordFormType' => '?',
            'App\\Form\\DobavljacType' => '?',
            'App\\Form\\FirmaType' => '?',
            'App\\Form\\GazdinstvoType' => '?',
            'App\\Form\\KomentarProizvodaType' => '?',
            'App\\Form\\KontaktType' => '?',
            'App\\Form\\OrderType' => '?',
            'App\\Form\\ProfilPassType' => '?',
            'App\\Form\\ProfilType' => '?',
            'App\\Form\\ProizvodType' => '?',
            'App\\Form\\RegistrationFizickoType' => '?',
            'App\\Form\\RegistrationGazdinstvoType' => '?',
            'App\\Form\\RegistrationType' => '?',
            'App\\Form\\ResetPasswordRequestFormType' => '?',
            'App\\Form\\RezervacijaType' => '?',
