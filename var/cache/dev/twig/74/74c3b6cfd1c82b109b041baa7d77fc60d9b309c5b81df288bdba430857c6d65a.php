...
/* admin_user/firme_list.html.twig */
class __TwigTemplate_b9dc8f7a3d4210a0e88785dd3431a1140b89ec7949c7766f6b60ca271c551a40 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin_user/firme_list.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin_user/firme_list.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "admin_user/firme_list.html.twig", 1);
...
";
    ...
    <div class=\"page-wrapper compact-wrapper dark-sidebar\" id=\"pageWrapper\">
        ...
        ";
        // line 19
        $this->loadTemplate("admin/admin_include/header.html.twig", "admin_user/firme_list.html.twig", 19)->display($context);
        // line 20
        ...
        <div class=\"page-body-wrapper\">
            ...
            ";
        // line 24
        $this->loadTemplate("admin/admin_include/navigation.html.twig", "admin_user/firme_list.html.twig", 24)->display($context);
        // line 25
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["firma"]) {
            ...
            echo "</td>
                                                <td><strong>";
            // line 61
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["firma"], "nazivFirme", [], "any", false, false, false, 61), "html", null, true);
            echo "</strong></td>
                                                <td>";
            // line 62
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["firma"], "pib", [], "any", false, false, false, 62), "html", null, true);
            echo "</td>
                                                <td>";
            // line 63
...
";
            ...
            // line 66
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_view_company", ["id" => twig_get_attribute($this->env, $this->source, $context["firma"], "id", [], "any", false, false, false, 66)]), "html", null, true);
...
";
                                                ...
                                                <div class=\"modal-dialog  modal-dialog-centered\">
                                                    <div class=\"modal-content\">
                                                        <div class=\"modal-body\">
                                                            <h5 class=\"modal-title\" id=\"staticBackdropLabel\">Obrišite firmu</h5>
            ...
            // line 80
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_delete_company", ["id" => twig_get_attribute($this->env, $this->source, $context["firma"], "id", [], "any", false, false, false, 80)]), "html", null, true);
        ...
        echo "                                        </tbody>
                ...
                ";
        // line 97
        $this->loadTemplate("admin/admin_include/footer.html.twig", "admin_user/firme_list.html.twig", 97)->display($context);
        // line 98
        echo "                <!-- footer End-->
            </div>
            <!-- index body end -->
    ...
    ";
        // line 107
        $this->loadTemplate("admin/admin_include/logout.html.twig", "admin_user/firme_list.html.twig", 107)->display($context);
        // line 108
        echo "    <!-- Modal End -->
";
...
";
    ...
    {
        return "admin_user/firme_list.html.twig";
    }
                                    ...
                                    <table id=\"example\" class=\"table table-striped\" style=\"width:100%\">
                                        ...
                                        {% for firma in firme %}
                                            <tr>
                                                <td>{{ loop.index }} </td>
                                                <td>{{ firma.id }}</td>
                                                <td><strong>{{ firma.nazivFirme }}</strong></td>
                                                <td>{{ firma.pib }}</td>
                                                <td>{{ firma.email }}</td>
{#                                                <td>{{ firma.city }}</td>#}
                                                <td>{{ firma.created | date(\"d.m.Y\") }}</td>
                                                <td class=\"text-center\"><a href=\"{{ path('app_admin_view_company', {id: firma.id}) }}\"><i data-feather=\"eye\" style=\"color:MediumSeaGreen;\"></i></a></td>
                                                ...
                                                <div class=\"modal-dialog  modal-dialog-centered\">
                                                    <div class=\"modal-content\">
                                                        <div class=\"modal-body\">
                                                            ...
                                                            <div class=\"button-box\">
                                                                <button type=\"button\" class=\"btn btn--no \" data-bs-dismiss=\"modal\">Ne</button>
                                                                <a class=\"btn  btn--yes btn-primary\" href=\"{{ path('app_admin_delete_company', {id: firma.id}) }}\" role=\"button\">Da</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
", "admin_user/firme_list.html.twig", "/home/prikolic/public_html/prikolica/templates/admin_user/firme_list.html.twig");
    }
}
