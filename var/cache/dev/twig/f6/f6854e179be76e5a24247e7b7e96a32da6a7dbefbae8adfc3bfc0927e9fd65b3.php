...
class __TwigTemplate_3a09a8a186e7ea15ffe05a3ac51c5d73a9b14b655f69a4ede73dbd139eff423a extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("layout.html.twig", "reset_password/check_email.html.twig", 1);
...
";
    ...
    ";
        // line 17
        $this->loadTemplate("include/header.html.twig", "reset_password/check_email.html.twig", 17)->display($context);
        // line 18
        echo "    <!-- mobile fix menu -->
    ";
        // line 19
        $this->loadTemplate("include/mobile_menu.html.twig", "reset_password/check_email.html.twig", 19)->display($context);
        // line 20
        echo "    <!-- home slider -->
        ...
        <div class=\"materialContainer\">
            <div class=\"box\">
                <div class=\"login-title\">
                    <h3>Email za reset lozinke je poslat</h3>
                </div>
                <p>
                    Ako postoji nalog koji se podudara sa email adresom koja je navedena, dobićete email koji sadži link za reset lozinke.
                    <br>Link ističe za ";
        // line 30
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 30, $this->source); })()), "expirationMessageKey", [], "any", false, false, false, 30), twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 30, $this->source); })()), "expirationMessageData", [], "any", false, false, false, 30), "ResetPasswordBundle"), "html", null, true);
        echo ".
                </p>
                <p>Ukoliko niste primili mail pogledajte u spam pošti ili <a href=\"";
        // line 32
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_forgot_password_request");
        echo "\">ponovite proces.</a>.</p>
            </div>
        </div>
    </div>
    <!-- Log In Section End -->
    ...
    ";
        // line 39
        $this->loadTemplate("include/footer.html.twig", "reset_password/check_email.html.twig", 39)->display($context);
        // line 40
        echo "    <!-- footer end -->
    ...
    ";
        // line 68
        $this->loadTemplate("include/top.html.twig", "reset_password/check_email.html.twig", 68)->display($context);
        // line 69
...
";
    ...
    {
        return array (  238 => 75,  228 => 74,  215 => 69,  213 => 68,  208 => 65,  206 => 64,  204 => 63,  202 => 62,  200 => 61,  198 => 60,  196 => 59,  194 => 58,  192 => 57,  190 => 56,  188 => 55,  186 => 54,  184 => 53,  182 => 52,  177 => 48,  172 => 44,  167 => 40,  165 => 39,  155 => 32,  150 => 30,  138 => 20,  136 => 19,  133 => 18,  131 => 17,  128 => 16,  118 => 15,  106 => 12,  101 => 9,  99 => 8,  94 => 6,  84 => 5,  71 => 3,  61 => 2,  38 => 1,);
    }
    ...
    <div class=\"login-section\">
        <div class=\"materialContainer\">
            <div class=\"box\">
                ...
                <p>
                    Ako postoji nalog koji se podudara sa email adresom koja je navedena, dobićete email koji sadži link za reset lozinke.
                    <br>Link ističe za {{ resetToken.expirationMessageKey|trans(resetToken.expirationMessageData, 'ResetPasswordBundle') }}.
                </p>
                <p>Ukoliko niste primili mail pogledajte u spam pošti ili <a href=\"{{ path('app_forgot_password_request') }}\">ponovite proces.</a>.</p>
            </div>
        </div>
    </div>
    <!-- Log In Section End -->
...
", "reset_password/check_email.html.twig", "/home/prikolic/public_html/prikolica/templates/reset_password/check_email.html.twig");
    }
}
